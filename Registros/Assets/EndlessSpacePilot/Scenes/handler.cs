...
{
    // Asegúrate de asignar este objeto en el editor de Unity
    ...
    IEnumerator GetProfile()
    {
        ...
        else
        {
            ...
            if (request.responseCode == 200)
            {
                ...
                int count = Mathf.Min(5, response.usuarios.Count); // Obtener el mínimo entre 5 y el total de usuarios
                ...
                // Actualiza el texto del objeto TMP Text con los primeros 5 puntajes
